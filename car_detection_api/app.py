...
from ml_model_arc import CarDetectorLightningClassifier
...
class CarDetector(Resource):
    ...
    def post(cls):
        ...
        mapping = {'cuda:0':'cpu'}
        classifier = CarDetectorLightningClassifier.load_from_checkpoint("./ml_model/model.pth", map_location=mapping)
        classifier.eval()
...
api.add_resource(CarDetector, "/detect_car")
